    ...
    <div className='home'>
      <div className='homeItem'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="date" id='date-input' name='date' onChange={handleChange} required></input>
          <label for="title">Title: </label>
          <input type="text" id='title' name='title' onChange={handleChange} required></input>
          <label for="description">Description: </label>
          <input type="text" id='description' name='description' onChange={handleChange} required></input>
